...
class Productos extends Controller
{
    ...
    public function registro()
    {
        ...
        $this->views->getView('admin/productos', "registro", $data);
    }
    ...
    public function listar()
    {
        ...
        for ($i = 0; $i < count($data); $i++) {
            ...
            $data[$i]['accion'] = '<div class="d-flex">
                <button class="btn btn-success me-2" type="button" onclick="agregarImagenes(' . $data[$i]['id'] . ')"><i class="fas fa-images"></i></button>
                <button class="btn btn-primary me-2" type="button" onclick="editPro(' . $data[$i]['id'] . ')"><i class="fas fa-edit"></i></button>
