 ...
 <div class="footer">
  <div class="container">
        ...
        <div class="row">
          <div class="col-6">
            <ul class="nav flex-column">
              <li class="nav-item mb-2"><a href="pages/shop-grid.html" class="nav-link">Verduras y Frutas</a></li>
              <li class="nav-item mb-2"><a href="pages/shop-grid.html" class="nav-link"> Desayuno y comida instantánea</a></li>
              <li class="nav-item mb-2"><a href="pages/shop-grid.html" class="nav-link"> Panadería y Galletas</a></li>
              <li class="nav-item mb-2"><a href="pages/shop-grid.html" class="nav-link">Harina, arroz y legumbres</a></li>
              <li class="nav-item mb-2"><a href="pages/shop-grid.html" class="nav-link">Salsas y untables</a></li>
              <li class="nav-item mb-2"><a href="pages/shop-grid.html" class="nav-link"> Orgánicos y gourmet</a></li>
              <li class="nav-item mb-2"><a href="pages/shop-grid.html" class="nav-link"> Cuidado del bebé</a></li>
              <li class="nav-item mb-2"><a href="pages/shop-grid.html" class="nav-link">Esenciales de limpieza</a></li>
              <li class="nav-item mb-2"><a href="pages/shop-grid.html" class="nav-link">Cuidado personal</a></li>
            </ul>
          </div>
          <div class="col-6">
            <ul class="nav flex-column">
              <li class="nav-item mb-2"><a href="pages/shop-grid.html" class="nav-link">Lácteos, pan y huevos</a></li>
              <li class="nav-item mb-2"><a href="pages/shop-grid.html" class="nav-link"> Bebidas frías y jugos</a></li>
              <li class="nav-item mb-2"><a href="pages/shop-grid.html" class="nav-link"> Té, café y bebidas</a></li>
              <li class="nav-item mb-2"><a href="pages/shop-grid.html" class="nav-link">Especias, aceites y más</a></li>
              <li class="nav-item mb-2"><a href="pages/shop-grid.html" class="nav-link">Pollo, carne y pescado</a></li>
              <li class="nav-item mb-2"><a href="pages/shop-grid.html" class="nav-link"> Esquina de paan</a></li>
              <li class="nav-item mb-2"><a href="pages/shop-grid.html" class="nav-link">Farmacia y bienestar</a></li>
              <li class="nav-item mb-2"><a href="pages/shop-grid.html" class="nav-link">Hogar y oficina</a></li>
              <li class="nav-item mb-2"><a href="pages/shop-grid.html" class="nav-link">Cuidado de mascotas</a></li>
            </ul>
          </div>
        </div>
        ...
        <div class="row g-4">
          ...
          <div class="col-6 col-sm-6 col-md-3">
            ...
            <ul class="nav flex-column">
              ...
              <li class="nav-item mb-2"><a href="pages/shop-shop-checkout.html" class="nav-link">Pago en tienda</a></li>
            </ul>
          </div>
        ...
        <div class="col-lg-5 text-lg-start text-center mb-2 mb-lg-0">
          <ul class="list-inline mb-0">
            ...
            <li class="list-inline-item">
              <a href="#!"><img src="<?php echo BASE_URL; ?>assets/images/payment/amazonpay.svg" alt=""></a>
            </li>
            <li class="list-inline-item">
              <a href="#!"><img src="<?php echo BASE_URL; ?>assets/images/payment/american-express.svg" alt=""></a>
            </li>
            <li class="list-inline-item">
              <a href="#!"><img src="<?php echo BASE_URL; ?>assets/images/payment/mastercard.svg" alt=""></a>
            </li>
            <li class="list-inline-item">
        ...
        <div class="col-lg-7 mt-4 mt-md-0">
          <ul class="list-inline mb-0 text-lg-end text-center">
            ...
            <li class="list-inline-item ms-4">
              <a href="#!"> <img src="<?php echo BASE_URL; ?>assets/images/appbutton/appstore-btn.svg" alt=""
                  style="width: 140px;"></a></li>
            <li class="list-inline-item">
              <a href="#!"> <img src="<?php echo BASE_URL; ?>assets/images/appbutton/googleplay-btn.svg" alt=""
                  style="width: 140px;"></a></li>
          </ul>
        </div>
      </div>
    ...
    <div class="border-top py-4">
      <div class="row align-items-center">
        <div class="col-md-6"><span class="small text-muted">Copyright 2025 © Mercado Express. Sistema Naiker. Todos los derechos reservados. Powered by Brayan.
        </span></div>
        <div class="col-md-6">
...
<script src="<?php echo BASE_URL; ?>assets/libs/prismjs/plugins/copy-to-clipboard/prism-copy-to-clipboard.min.js"></script>
