        ...
        <div class="row">
            ...
            <div class="col-12">
                <div class="p-6 d-flex justify-content-between align-items-center d-md-none">
                    <!-- heading -->
                    <h3 class="fs-5 mb-0">Completado</h3>
                    <!-- button -->
            ...
            <div class="col-lg-3 col-md-4 col-12 border-end  d-none d-md-block">
                <div class="pt-10 pe-lg-10">
                    ...
                    <ul class="nav flex-column nav-pills nav-pills-dark">
                        ...
                        <!-- nav item -->
                        <li class="nav-item">
                            <a class="nav-link active" href="<?php echo BASE_URL . 'principal/completado' ?>">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo BASE_URL . 'principal/notiicaciones' ?>">
    ...
    <div class="offcanvas-body">
        <ul class="nav flex-column nav-pills nav-pills-dark">
            ...
            <li class="nav-item">
                ...
                <i class="feather-icon icon-settings me-2"></i></i>Configuracion</a>
            </li>
        </ul>
        <hr class="my-6">
        <div>
